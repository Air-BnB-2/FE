...
const listingsFormSchema = Yup.object().shape({
    ...
    propertyType: Yup
    .string()
    .oneOf(['apartment', 'house', 'condominium', 'loft', 'townhouse', 'hostel', 'other'], 'Please select a property type'),
    roomType: Yup
    .string()
    .oneOf(['entire', 'private', 'shared'], 'Please select a room type'),
    guests: Yup
    .string()
    ...
    beds: Yup
    .string()
    .required('Please select number of beds'),
    bathrooms: Yup
    .string()
    .required('Please select number of bathrooms'),
    cancellation: Yup
    .string()
    .oneOf(['strict', 'moderate', 'flexible', 'superStrict30', 'superStrict60'], 'Please select cancellation policy')
})
